		...
		<div id="searchbar_wrapper" className={styles.searchBarWrapper}>
			<div className={styles.searchBarContainer}>
				<div className={styles.searchBarLocality} onClick={() => showSuggestion('places')}>
					...
					{showPlaces ? (
						<Link to = "/search"><SuggestionListItem handleQuery={handleQuery} list={suggestionList} type='places' /></Link>
					) : (
						''
					)}
				</div>
				<div className={styles.searchBarKeyword} onClick={() => showSuggestion('speciality')}>
					...
					{showSpeciality ? (
						<Link to = "/search" ><SuggestionListItem handleQuery={handleQuery} list={suggestionList} type='speciality' /></Link>
					) : (
						''
					)}
				</div>

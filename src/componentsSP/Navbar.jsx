    ...
    return <div className="navbar-area">
        <nav className="nav-container">
            <div className="div-nav-left">
                <img src={'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn.freelogovectors.net%2Fwp-content%2Fuploads%2F2019%2F02%2FPracto-logo.png&f=1&nofb=1'} alt="practo-logo" className='nav-logo' />
            </div>
            ...
            <div className="div-nav-right">
                ...
                <button className="btn-login" ><a href="http://localhost:3000/signup"> 
                    Login / Signup   
                    </a>
                </button>
            </div>
